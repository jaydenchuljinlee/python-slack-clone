...
class ChatSerializer(serializers.Serializer):
    ...
    converted_created_at = serializers.SerializerMethodField(read_only=True)

    def get_converted_created_at(self, obj):
        return obj.created_at.strftime('%a %b %d %Y %H:%M:%S')
